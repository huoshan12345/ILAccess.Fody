...
///
/// For <see cref="ILAccessorKind.Method"/>, <see cref="ILAccessorKind.StaticMethod"/>,
/// <see cref="ILAccessorKind.Field"/>, and <see cref="ILAccessorKind.StaticField"/>, the type of
...
public sealed class ILAccessAttribute : Attribute
{
    ...
    /// The name must be unset/<code>null</code> for <see cref="ILAccessorKind.Constructor"/>.
    /// </remarks>
